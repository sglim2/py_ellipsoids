...
#=============================================================================
    def __init__(self, ngrid=24):
        ...
        self.TP      = np.zeros((3*NT,3))   # Vertices fo triangles
        self.NP      = np.zeros((3*NT,3))   # Normal at each triangle vertex
        self.indices = np.zeros(3*2*NT,dtype=int) # vertice and normal locations (for use with pycollada)
...
#=============================================================================
    def rotate_about_u(self,theta,u):
        ...
        self.TP[:] =  np.dot(R,np.transpose(TP[:]))
        self.NP[:] =  np.dot(R,np.transpose(NP[:]))
